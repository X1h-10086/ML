...
# 1.加载数据集
heart_disease_data = pd.read_csv("C:\\Users\\xieyi\ML\\test data\data\heart_disease.csv")
...
# 3.特征工程
# 数值型特征
numerical_feature = ["年龄", "静息血压", "胆固醇", "最大心率", "运动后的ST下降", "主血管数量"]
# 类别型特征
categorical_feature = ["胸痛类型", "静息心电图结果", "峰值ST段的斜率", "地中海贫血"]
# 二元特征
binary_feature = ["性别", "空腹血糖", "运动性心绞痛"]
